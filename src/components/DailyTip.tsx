...
export const DAILY_TIPS: Tip[] = [
  ...
  {
    id: 15,
    title: "マスタリーの報酬(ウルトラレア未満)",
    content: "コイン:2000, パワーポイント:300, クレジット:225を受け取ることができます"
  },
  {
    id: 16,
    title: "マスタリーの報酬(ウルトラレア以上)",
    content: "コイン:3000, パワーポイント:450, クレジット:300を受け取ることができます"
  },
  {
    id: 17,
    title: "マスタリーの効率の良い集め方",
    content: "マスタリーはトロフィーが高ければ高いほど受け取れる量が増えます"
  }
];
