...
export const maps: GameMaps = {
  ...
  knockout: [
    "ゴールドアームの渓谷", "白熱対戦", "新たなる地平", "オープンフィールド", "生い茂る廃墟", 
    "バキューン神殿", "極小列島", "双頭の川", "ベルの岩", "密林の奥地", "燃える不死鳥", "四段階層", 
  ],
  emeraldHunt: [
    "エメラルドの要塞" ,"ごつごつ坑道", "ラストストップ", "トロッコの狂気", "オープンスペース",
    "廃れたアーケード", "アンダーマイン", "クリスタルアーケード", "サボテンの罠", "ダブルレール", "森林伐採", "クールロック", 
  ],
  heist: [
