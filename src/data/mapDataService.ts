...
export const maps = {
  battleRoyale: [
       "コスモコア", "ダブルトラブル, "天国と地獄", "空飛ぶ絨毯", "リリーラグーン", 
      　"禁断の33", "岩壁の決戦", "安全センター", "ガイコツ川", "ウェーブフォーム", 
    　　"酸性湖", "激動の洞窟"
  ],
  knockout: [
    "ディープエン洞窟″, "淀みなき泉", "四段階層", "ゴールドアームの渓谷", 
　　　"白熱対戦", "リスキーロード", "深緑の古道", "新たなる地平", "新天地", 
　　　"オープンフィールド", "ベルの岩", "一触即発"
  ],
  gemGrab: [
     "ダブルレール", "森林伐採", "エメラルドの要塞", "ごつごつ坑道", "ラストストップ", 
    　"フローラルレイク", "グルメタウン", "オープンスペース", "寂れたアーケード", "アンダーマイン", 
  　　　"クリスタルアーケード", "サボテンの罠", 
  ],
  heist: [
      "ビートルバトル", "どんぱち谷", "フィッシングヘイブン", "ピットストップ", 
      "オープンビジネス", "プレーンテキスト", "オープンゾーン", "安全地帯", 
      "炎のリング", "橋の彼方", "クリスタルホール", "ホットポテト"
  ],
  brawlBall5v5: [
    "ガーデンクラッシャーズ", "シベリアの決戦", "幻想の樹海", "冷血サバイバル", 
    "狂気の幻影", "ストレージスタジアム", "トレジャーアイランド", "アンハッピーアリーナ", 
    "合流地点", "凍てつく波紋", "フローズントラップ", "近くの地下室", "ため池大決戦", 
    "ポーラーパーク", "極寒採掘", "シズリングチャンパー"
  ],
  brawlBall: [
    "狭き門", "サボテン王国", "スカイハイランナー", "セカンドチャンス", 
    "静かな広場", "サニーサッカー", "スーパービーチ", "トリッキー", 
    "トリプルドリブル", "鉄壁の護り", "ビーチボール", "ピンボールドリーム", 
  ],
  duel: [
    ″乾燥地帯″, ″猿の迷路″, ″果てしなき不運, ″隠れ家", "不屈の精神", 
    "レイヤーケーキ", "ミルフィーユ", "見えざる大蛇", "暴徒のオアシス", 
    "言い訳厳禁", "常勝街道", "スパイスプロダクション", "流れ星", "禅の庭園", 
    "大いなる入口", "インパクトゾーン", "ハリケーン", "シークレットガーデン", 
  ],
  brawlHockey: [
