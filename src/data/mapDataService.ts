...
　　　"オープンフィールド", "ベルの岩", "一触即発"
  ...
  duel: [
    "流れ星", "禅の庭園", "大いなる入口", "インパクトゾーン", "ハリケーン", 
    "シークレットガーデン", ″乾燥地帯″, ″猿の迷路″, ″果てしなき不運, ″隠れ家", 
    "不屈の精神", "レイヤーケーキ", "ミルフィーユ", "見えざる大蛇", "暴徒のオアシス", 
    "言い訳厳禁", "常勝街道", "スパイスプロダクション", 
  ],
  brawlHockey: [
