...
export const gearIcons: IconMapping = {
  "シェリー": {
    1: require('../../assets/GearIcon/gear_superrare_speed.png'),
    2: require('../../assets/GearIcon/gear_superrare_vision.png'),
    3: require('../../assets/GearIcon/gear_superrare_heal.png'),
    4: require('../../assets/GearIcon/gear_superrare_shield.png'),
    5: require('../../assets/GearIcon/gear_superrare_damage.png'),
