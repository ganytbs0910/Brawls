...
export const emeraldHuntMaps: Record<string, MapDetail> = {
  ...
  "廃れたアーケード": {
    ...
    recommendedBrawlers: [
      ...
      { name: "グレイ", reason: "", power: 2 },
      { name: "クロウ", reason: "", power: 1 }
    ],
