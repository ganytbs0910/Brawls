...
export const knockoutMaps: Record<string, MapDetail> = {
  ...
  "オープンフィールド": {
    ...
    recommendedBrawlers: [
      ...
      { name: "Mr.P", reason: "", power: 2 },
      { name: "ペニー", reason: "", power: 2 },
      { name: "レオン", reason: "", power: 2 },
      { name: "マックス", reason: "", power: 2 },
      { name: "ローラ", reason: "", power: 2 },
      { name: "バスター", reason: "", power: 2 },
  ...
  "燃える不死鳥": {
    ...
    recommendedBrawlers: [
      ...
      { name: "ダリル", reason: "", power: 3 },
      { name: "Mr.P", reason: "", power: 3 },
      { name: "パム", reason: "", power: 2 },
      { name: "ベリー", reason: "", power: 2 },
      { name: "グロム", reason: "", power: 1 },
    ],
